...
# build/bin/clang -O0 --target=riscv64 -march=rv64gc --sysroot=$RISCV_TOOLCHAIN_PATH/riscv64-unknown-elf/ --gcc-toolchain=$RISCV_TOOLCHAIN_PATH $1-dis.ll -o $1-raised-static
...
# build/bin/clang -O3 --target=riscv64 -march=rv64gc --sysroot=$RISCV_TOOLCHAIN_PATH/riscv64-unknown-elf --gcc-toolchain=$RISCV_TOOLCHAIN_PATH $1-raised-opt.ll -o $1-raised-static-opt
